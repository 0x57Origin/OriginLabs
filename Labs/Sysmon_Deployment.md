...
```
-URI - Uniform Resource Locator. Also if you ever want to change directory and the username has space in it like -> Random User -> You can use -> cd "Location" and 
it will not cause any error issues in PowerShell.
